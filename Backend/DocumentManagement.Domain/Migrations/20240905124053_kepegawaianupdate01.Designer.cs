...
namespace DocumentManagement.Domain.Migrations
{
    ...
    [Migration("20240905124053_kepegawaianupdate01")]
    partial class kepegawaianupdate01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentManagement.Data.Dosen", b =>
                {
                    b.HasBaseType("DocumentManagement.Data.Pegawai");

                    b.Property<string>("DosenTetapNIP")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DocumentManagement.Data.Tendik", b =>
                {
                    ...
                    b.Property<string>("TendikTetapNIP")
                        .HasColumnType("nvarchar(450)");

                    b.HasIndex("TendikTetapNIP");
            ...
            modelBuilder.Entity("DocumentManagement.Data.DosenTetap", b =>
                {
                    b.HasBaseType("DocumentManagement.Data.Dosen");
            ...
            modelBuilder.Entity("DocumentManagement.Data.TendikTetap", b =>
                {
                    b.HasBaseType("DocumentManagement.Data.Tendik");
            ...
            modelBuilder.Entity("DocumentManagement.Data.Dosen", b =>
                {
                    b.HasOne("DocumentManagement.Data.DosenTetap", "DosenTetap")
                        .WithMany()
                        .HasForeignKey("DosenTetapNIP");

                    b.HasOne("DocumentManagement.Data.Pegawai", "Pegawai")
                        .WithOne("Dosen")
                        .HasForeignKey("DocumentManagement.Data.Dosen", "NIP")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DocumentManagement.Data.Tendik", b =>
                {
                    b.HasOne("DocumentManagement.Data.Pegawai", "Pegawai")
                        .WithOne("Tendik")
                        .HasForeignKey("DocumentManagement.Data.Tendik", "NIP")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DocumentManagement.Data.TendikTetap", "TendikTetap")
                        .WithMany()
                        .HasForeignKey("TendikTetapNIP");
            ...
            modelBuilder.Entity("DocumentManagement.Data.DosenTetap", b =>
                {
                    b.HasOne("DocumentManagement.Data.Dosen", null)
                        .WithOne()
                        .HasForeignKey("DocumentManagement.Data.DosenTetap", "NIP")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DocumentManagement.Data.TendikTetap", b =>
                {
                    b.HasOne("DocumentManagement.Data.Tendik", null)
                        .WithOne()
                        .HasForeignKey("DocumentManagement.Data.TendikTetap", "NIP")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
