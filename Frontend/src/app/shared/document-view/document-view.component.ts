...
export class DocumentViewComponent extends BaseComponent implements OnInit {
  ...
  getDocumentById() {
    ...
    if (this.data.isRestricted) {
      this.sub$.sink = this.documentLibraryService.getDocumentLibrary(this.data.documentId).subscribe((c) => {
      ...
      this.sub$.sink = this.documentLibraryService.getDocumentViewLibrary(this.data.documentId).subscribe((c) => {
        this.isLoading = false
        this.documentInfo = c
        this.viewerType = this.documentInfo.viewerType
        this.getDocumentUrl()
